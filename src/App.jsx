  ...
  return (
    <div className="form-container">
      ...
      {/*         
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row justify-center mt-12 border-t pt-8" style={{ gap: '40px' }}>
